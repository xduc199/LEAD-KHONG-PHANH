...
public class ExciterController : MonoBehaviour
{
    ...
    //=============================================================
    // AMBULANCE COLLISION STATE
    //=============================================================

    private float nextAmbulanceHitTime;
    ...
    private void CheckDistanceCollisions()
    {
        ...
        if (
            Time.time >=
            nextAmbulanceHitTime
        )
        {
            if (CheckAmbulanceCollision())
            {
                return;
            }
        }
    ...
    private bool CheckAmbulanceCollision()
    {
        ...
        AmbulanceController closestAmbulance =
            null;
        ...
        )
        {
            ...
            AmbulanceController ambulance =
                hit.GetComponentInParent<AmbulanceController>();

            if (ambulance == null)
            {
                ambulance =
                    hit.GetComponentInChildren<AmbulanceController>(
                        true
                    );
            }
            ...
            // Chỉ xử lý Ambulance đang ở phía trước Exciter.
            if (
                forwardDistance <
                -1f
            )
    ...
    private void TriggerAmbulanceHit(
        AmbulanceController ambulance
    )
    {
        if (isKnockedBack)
